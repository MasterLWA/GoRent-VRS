...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="topnav container-fluid">
        ...
        <a href="SelectUserTypeLog.php"  class="active" style="margin-left:800px">Log in</a>
      ...
      <div class="row py-4">
        ...
        <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li class="mb-2"><a href="userLogin.php" class="flinks">Login Customer</a></li>
            <li class="mb-2"><a href="VOwnerLogin.php" class="flinks">Log in Vehicle Owners</a></li>
            <li class="mb-2"><a href="SelectUserTypeReg.php" class="flinks">Register</a></li>
          </ul>
        </div>
        <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
          <h6 class="text-uppercase font-weight-bold mb-4">Company</h6>
          <ul class="list-unstyled mb-0">
            <li class="mb-2"><a href="ManagerLogin.php" class="flinks">Manager Login</a></li>
            <li class="mb-2"><a href="contact.php" class="flinks">Contacts</a></li>
